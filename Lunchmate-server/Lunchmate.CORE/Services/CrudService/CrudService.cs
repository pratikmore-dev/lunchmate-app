...
namespace Lunchmate.Core.Services
{
    public class CrudService<TEntity> : ICrudService<TEntity> where TEntity : class
    {
        ...
        public virtual async Task<Result<TCreateResponse>> Create<TCreateRequest, TCreateResponse>(TCreateRequest input)
        {
        ...
        public virtual async Task<Result<TUpdateResponse>> Update<TUpdateRequest, TUpdateResponse>(TUpdateRequest input, string id)
        {
